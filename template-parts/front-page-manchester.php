<?php
/*
Template Name: front-page-manchester
*/
?>
...
<header class="page-header">
	<div class="block__content">
			<h4 class="page-title">
				<a href="https://streetsupport.net">Home</a> &gt; Manchester News
			</h4>
	</div>
</header>
<div class="block__content">
  <?php query_posts('category_name=stories&tag=manchester&showposts=1');
  ...
  ?>
      ...
      <div id="latest-stories-posts" class="container-post-excerpt">
			...
			<div class="text-wrap-div">
				<h3><a class="read-more" href="<?php echo esc_url( get_permalink() ) ?>" rel="bookmark">Latest Manchester Story</a></h3>
				<?php get_template_part( 'template-parts/content-front-page-catexcerpt', 'page' );?>
			</div>

			<a class="main-image-block__more-link" href="<?php echo get_site_url(); ?>/category/stories/?tag=manchester">More Manchester Stories</a>
		</div>
	</div>
	<?php query_posts('category_name=articles&tag=manchester&showposts=1');
		while ( have_posts() ) : the_post();
		  $src = wp_get_attachment_image_src( get_post_thumbnail_id($post->ID), array( 5600,1000 ), false, '' );
		endwhile;
	?>
	<div class="main-image-block" style="background-image: url(<?php echo $src[0]; ?> ) !important;">
		<div id="latest-about-homelessness-posts" class="container-post-excerpt">
			<div class="text-wrap-div">
				<h3><a class="read-more" href="<?php echo esc_url( get_permalink() ) ?>" rel="bookmark">Manchester Articles</a></h3>
				<?php get_template_part( 'template-parts/content-front-page-catexcerpt', 'page' );
        ?>
			</div>
...
<div class="block block">
	<div class="block__content">
		<div id="latest-news-posts" class="front-page__news">
			<h1 class="h1 front-page__news-heading">Latest Manchester News</h1>
			<div class="front-page__news-list">
				<?php query_posts('category_name=latest-news&tag=manchester&showposts=3');
				while ( have_posts() ) : the_post();
        ...
        ?>
			...
			<a href="<?php echo get_site_url (); ?>/category/latest-news/?tag=manchester" class="btn btn--brand-e"><span class="btn__text">Read More Manchester News Stories</span></a>
		</div>
	</div>
</div>
